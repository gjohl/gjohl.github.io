...
- Recreate the [collaborative filtering spreadsheet](https://docs.google.com/spreadsheets/d/1tIzbgwu3qmAJounfKtr4n-uwAkupetmVqkHAWllYRDw/edit?usp=sharing)
:::
...
Doing a matrix multiply by a one hot encoded vector is the same as dogit sng a lookup in an array, just in a more computationally efficient way. Recall the softmax example. 
