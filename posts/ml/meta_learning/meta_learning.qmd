...
- Make small improvements (daily)
    - Small tweaks compund into big results
...
- Find an appropriate validation split that mirrors the leaderboard
    ...
    - Train two models and submit them. The leaderboard results should reflect what you saw locally (i.e. which was he better model). If not, you might have problems with your validation split.
...
- Papers, blogs and creativity will take you the remaining 20%
    ...
    - Blog posts are often more accessible and quick to implement.
