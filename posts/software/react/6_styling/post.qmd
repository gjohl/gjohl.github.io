...
1. Vanilla CSS - inline or separate modules 
2. Scoped CSS with modules
3. CSS-in-React with styled components 
4. Tailwind CSS
...
Inline styles. 
You can set the style prop of each component. 
...
You import slightly differently as it now returns a JavaScript object. 
...
Tailwind CSS. 
This is another 3rd party framework. The idea is you don’t need to know CSS. Instead you apply small predefined utility classes to each component to achieve a style, and these abstract away a lot of the CSS styles. 
