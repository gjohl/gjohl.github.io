...
![Yellow Pages](yellow_pages.png){.lightbox #fig-yellow_pages}
...
![Stateless](stateless.png){.lightbox #fig-stateless}
...
![Central Logging Service](central_logging_service.png){.lightbox #fig-central_logging_service}
