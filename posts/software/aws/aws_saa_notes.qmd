...
# 22. Disaster Recovery and Migrations 

## 22.1. Disaster Recovery Overview
...
## 22.2. Disaster Recovery - Practical Tips
...
## 22.3. Database Migration Service (DMS)
### 22.3.1 Overview
...
### 22.3.2. AWS Schema Conversion Tool (SCT)
...
### 22.3.5. RDS and Aurora MySQL Migrations
...
## 22.4. On-Premises Strategy with AWS
...
## 22.6. AWS Migration Service (MGN)
### 22.6.1. AWS Application Discovery Service
**AWS Application Discovery Service gathers information about your on-premises servers to help plan a migration**. It tracks server utilisation, dependency mappings, etc and can be viewed in AWS Migration Hub.
...
### 22.6.3. Transfer Large Amounts of Data into AWS
...
## 23.4. High Performance Computing
...
## 23.5. Creating a Highly Available EC2 Instance
...
### 24.1.2. CloudFormation Service Roles
...
## 24.4. System Manager (SSM)
### 24.4.1. SSM Session Manager
